...
def store_data():
    ...
    proposal_dict = download_and_save_proposal(db, counter)
...
def trigger_trade(new_row_df, summary_obj, sentiment_analyzer):
    ...
    if len(new_row_df) != 0:
        ...
        for index, row in new_row_df.iterrows():
            ...
            if sentiment == 'positive' and sentimnet_score >= 0.5:
            ...
            if sentiment == 'negative' and sentimnet_score >= 0.5:
